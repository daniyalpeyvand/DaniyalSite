...
namespace DaniyalSite.Areas.Admin.Controllers
{
	[Authorize]
	public class PagesController : Controller
	{
		...
		public ActionResult Create([Bind(Include = "PageID,GroupID,Title,Text,ShortDescription,Visit,ImageName,ShowSlider,CreateDate,Tags")] Page page, HttpPostedFileBase imgUp)
		{
		...
		[HttpPost]
		[ValidateAntiForgeryToken]
		public ActionResult Edit([Bind(Include = "PageID,GroupID,Title,Text,ShortDescription,Visit,ImageName,ShowSlider,CreateDate,Tags")] Page page, HttpPostedFileBase imgUp)
		{
			if (ModelState.IsValid)
			{
				page.Visit = 0;
